---
name: clarifier
description: Clarifies user research requests through layered questioning. Uses AskUserQuestion for multi-choice questions, Read to load context, WebSearch to research domain before asking questions.
model: sonnet
---
